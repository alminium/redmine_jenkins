...
[1.0.0] You can get build results using rake task 'redmine_hudson:fetch', and choose format to write job description. HTML or Textile. You can also change description visibility dynamically.
